...
if(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C562RE")
  ...
  target_compile_options(${CMAKE_PROJECT_NAME} PUBLIC "SHELL:-D 'SHARED_HEADER_INCLUDE=\"../USB_CDC/USB_CDC_cmake/shared.h\"' -DDEBUG -g3 -O0 -fdata-sections -ffunction-sections -std=gnu11 -Wall -fstack-usage --specs=nano.specs --specs=nosys.specs -Werror=implicit-function-declaration ${CC_SECURE}")
  target_include_directories(${CMAKE_PROJECT_NAME} PUBLIC . arch/cmsis/CMSIS/Core/Include generated/hal stm32c5xx_dfp/Include stm32c5xx_drivers/hal stm32c5xx_drivers/ll stm32c5xx_drivers/timebases user_modifiable/Device/STM32C562RET6 user_modifiable/_debug_GCC_NUCLEO-C562RE)
