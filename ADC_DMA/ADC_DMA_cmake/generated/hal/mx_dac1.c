...
hal_dac_handle_t *mx_dac1_init(void)
{
  ...
  if (HAL_DMA_SetConfigPeriphLinkedListCircularXfer(&hLPDMA1_CH1, &DMA_Node_DAC1_CH1, &xfer_cfg_dac1_ch1_dma) != HAL_OK)
  {
    return NULL;
  }
  ...
  HAL_DAC_SetChannelDMA(&hDAC1, &hLPDMA1_CH1, HAL_DAC_CHANNEL_1);
