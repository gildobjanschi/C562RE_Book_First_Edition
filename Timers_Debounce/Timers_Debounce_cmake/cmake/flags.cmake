...
if(CMAKE_BUILD_TYPE STREQUAL "debug_GCC_NUCLEO-C562RE")
  ...
  target_compile_options(${CMAKE_PROJECT_NAME} PUBLIC "SHELL:-D 'SHARED_HEADER_INCLUDE=\"../Timers_Debounce/Timers_Debounce_cmake/shared.h\"' -DDEBUG -g3 -O0 -fdata-sections -ffunction-sections -std=gnu11 -Wall -fstack-usage --specs=nano.specs --specs=nosys.specs -Werror=implicit-function-declaration ${CC_SECURE}")
