...
#define RE_BTN_PORT                                     HAL_GPIOA
#define RE_BTN_PIN                                      HAL_GPIO_PIN_7
...
#define RE_A_PORT                                       HAL_GPIOC
#define RE_A_PIN                                        HAL_GPIO_PIN_11
...
#define RE_B_PORT                                       HAL_GPIOD
#define RE_B_PIN                                        HAL_GPIO_PIN_2
...
/**
  * @brief  Get the EXTI7 object.
  * @retval Pointer on the EXTI7 Handle
  */
hal_exti_handle_t *mx_gpio_default_exti7_gethandle(void);

/**
  * @brief  Get the EXTI11 object.
  * @retval Pointer on the EXTI11 Handle
  */
